            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-xs mt-4">
                        © {new Date().getFullYear()} AgendeJá by EFF5. Todos os direitos reservados. v0.7.0 | <a href="/termos" className="hover:text-primary transition-colors">Termos</a> | <a href="/privacidade" className="hover:text-primary transition-colors">Privacidade</a>
                    </p>
                </div>
