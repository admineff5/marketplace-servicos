...
const pastReplacement = `past.map(item => (
                        <div key={item.id} className="bg-white dark:bg-[#111] border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm hover:shadow-md transition-all flex flex-col overflow-hidden group opacity-85 hover:opacity-100">
                            ...
                            <div className="p-4 flex-1 flex flex-col justify-between">
                                <div>
                                    <h3 className="text-md font-bold text-gray-900 dark:text-white mb-0.5 line-clamp-1">{item.service}</h3>
                                    <p className="font-medium text-gray-500 text-xs mb-3">{item.company}</p>

                                    <div className="flex items-center gap-1.5 bg-gray-50 dark:bg-[#1a1a1c] px-3 py-1.5 rounded-lg border border-gray-100 dark:border-gray-800/50 w-fit mb-3">
                                ...
                                <div className="border-t border-gray-100 dark:border-gray-800 pt-3">
                                    ...
                                    <div className="flex gap-2">
                                        <button className="flex-1 py-1.5 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors flex items-center justify-center gap-1">
                                            <Receipt className="w-3.5 h-3.5" /> Recibo
                                        </button>
                                        <button 
                                            onClick={() => handleRebook(item)} 
                                            className="flex-1 py-1.5 bg-cyan-500/10 text-cyan-700 dark:bg-primary/20 dark:text-primary border border-cyan-600/30 dark:border-primary/30 rounded-lg text-xs font-bold hover:bg-cyan-700 hover:text-white dark:hover:bg-primary dark:hover:text-black transition-colors"
                                        >
                                            Agendar de Novo
                                        </button>
                                    </div>
